...
🛠️ Usage
Launch PowerPoint and open the presentation you wish to use.

Run the controller:

python ppt_voice_control.py

Wait for Calibration: The system will spend 1 second calibrating for background noise.

Speak Clearly: Once you see the [SYSTEM ONLINE] message, speak your commands.
